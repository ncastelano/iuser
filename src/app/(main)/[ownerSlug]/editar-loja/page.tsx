// app/(main)/[ownerSlug]/editar-loja/page.tsx
'use client'
...
export default function EditarLoja() {
    ...
    // ===== CORREÇÃO: Agora usa ownerSlug como storeSlug =====
    const ownerSlug = Array.isArray(params.ownerSlug) ? params.ownerSlug[0] : params.ownerSlug
    const storeSlugParam = ownerSlug // A loja é identificada pelo ownerSlug
    ...
    return (
        <div className="relative min-h-dvh" style={{ background: colors.background }}>
            ...
            <header className="relative z-10 sticky top-0 px-4 py-3 border-b border-orange-200/30 bg-white/60 backdrop-blur-xl">
            ...
            <main className="relative z-10 flex-1 px-4 py-6 flex justify-center pb-32">
